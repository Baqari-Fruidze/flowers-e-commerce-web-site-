     ...
     {products?.map((item, index)=>(
      <div className="container" key={index}>
        <div className="descr">
            ...
            <p style={{width: "50px"}} className="productName">{item.name}</p> 
            <p style={{width: "50px"}} className="productName">{item.category.name}</p> 
            <p style={{width: "280px"}} className="productName">{item.description}</p>
            <p style={{width: "10px"}} className="productName">{item.price}</p>

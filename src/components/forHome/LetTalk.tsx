  ...
  return (
    <>
      <ToContactUs>
        ...
        <Contact>
          <p className="contactUsTitle" data-aos="fade-up">
            To Contact Us
          </p>
          ...
          <div className="bookACall">
            ...
            />
            <button className="bookACallBtn">
              <p className="anim">BOOK A CALL</p>
            </button>
          </div>
          ...
          <PhoneAdress>
            <div className="phoneAdress">
              ...
              <div>
                <span>
                  <img
                    src={
                      "https://uploads-ssl.webflow.com/6400d82951450021c2d1eb7b/64a2b419cf29328d429a83a1_phone.svg"
                    }
                    alt=""
                  />
            ...
            <div className="phoneAdress" id="phoneAdressTitle">
              ...
              <div>
                <p className="phoneAdressDecsr, open">
                  OPENNING HOURS: 8 TO 11 PM
                </p>
                <p className="phoneAdressDecsr, openAdress">
                  N 223 Chavchavadze Avenue, Telavi
                </p>
              </div>
            </div>

      ...
      <MainPop>
        ...
        <ProfileCont>
          <TitleIcon>
            ...
            >
              <path
                d="M12.957 7.42168L5.45703 3.09668"
                stroke="currentColor"
              ...
              ></path>
              <path
                d="M16.707 12.9218V6.25513C16.7067 5.96286 16.6296 5.6758 16.4833 5.42276C16.337 5.16972 16.1268 4.9596 15.8737 4.81346L10.0404 1.48013C9.787 1.33385 9.49959 1.25684 9.20703 1.25684C8.91447 1.25684 8.62706 1.33385 8.3737 1.48013L2.54036 4.81346C2.28725 4.9596 2.07701 5.16972 1.93075 5.42276C1.78448 5.6758 1.70733 5.96286 1.70703 6.25513V12.9218C1.70733 13.2141 1.78448 13.5011 1.93075 13.7542C2.07701 14.0072 2.28725 14.2173 2.54036 14.3635L8.3737 17.6968C8.62706 17.8431 8.91447 17.9201 9.20703 17.9201C9.49959 17.9201 9.787 17.8431 10.0404 17.6968L15.8737 14.3635C16.1268 14.2173 16.337 14.0072 16.4833 13.7542C16.6296 13.5011 16.7067 13.2141 16.707 12.9218Z"
                stroke="currentColor"
                stroke-width="1.71591"
                stroke-linecap="round"
                stroke-linejoin="round"
              ></path>
              <path
                d="M1.93164 5.38867L9.20664 9.59701L16.4816 5.38867"
                stroke="currentColor"
                stroke-width="1.71591"
                stroke-linecap="round"
                stroke-linejoin="round"
            ...
            <Link to="/My-order">
              <p
                onClick={() => {
                  setIsAcount(true), setIsMyProfile(false);
                }}
              >
                My Order
              </p>
          ...
          <TitleIcon>
            ...
            >
              <path
                d="M17.5741 2.601C17.1485 2.17517 16.6431 1.83737 16.0869 1.6069C15.5307 1.37644 14.9345 1.25781 14.3325 1.25781C13.7304 1.25781 13.1342 1.37644 12.578 1.6069C12.0218 1.83737 11.5164 2.17517 11.0908 2.601L10.2075 3.48433L9.32412 2.601C8.46438 1.74126 7.29832 1.25826 6.08246 1.25826C4.86659 1.25826 3.70053 1.74126 2.84079 2.601C1.98105 3.46074 1.49805 4.62681 1.49805 5.84267C1.49805 7.05853 1.98105 8.22459 2.84079 9.08433L3.72412 9.96767L10.2075 16.451L16.6908 9.96767L17.5741 9.08433C18 8.6587 18.3377 8.15334 18.5682 7.59713C18.7987 7.04091 18.9173 6.44474 18.9173 5.84267C18.9173 5.24059 18.7987 4.64442 18.5682 4.0882C18.3377 3.53199 18 3.02663 17.5741 2.601V2.601Z"
                stroke="currentColor"
                stroke-width="1.71591"
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <TitleIcon>
            ...
            >
              <path
                d="M10.416 12.5693C11.7967 12.5693 12.916 11.45 12.916 10.0693C12.916 8.68862 11.7967 7.56934 10.416 7.56934C9.0353 7.56934 7.91602 8.68862 7.91602 10.0693C7.91602 11.45 9.0353 12.5693 10.416 12.5693Z"
                stroke="currentColor"
                stroke-width="1.71591"
                stroke-linecap="round"
                stroke-linejoin="round"
